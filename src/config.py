...
def get_params():
    ...
    parser.add_argument("--tgt_dm", type=str, default="drugs", help="target domain")
    parser.add_argument("--src_dm", type=str, default="conll", help="source domain")
    parser.add_argument("--cut_strategy", type=int, default=1, help="How to split text. 1=cutoff after 500 subtokens, 2=split into parts with around 400, 3=cut to sentences.")
    ...
    parser.add_argument("--n_layer", type=int, default=1, help="number of layers for LSTM") # Re-USED FROM BiLSTM
    ...
    parser.add_argument("--wnut", default=False, action="store_true",
                        help="use WNUT-2017 NER dataset for pre-training")
    parser.add_argument("--btc", default=False, action="store_true",
                        help="use Broad Twitter Corpus NER dataset for pre-training")
    parser.add_argument("--wiki", default=False, action="store_true",
                        help="use Distantly Supervised Wikipedia Drug NER dataset for pre-training")
    parser.add_argument("--wnut_nutot", default=False, action="store_true",
                        help="use WNUT + NUTOT dataset for pre-training")
    parser.add_argument("--nutot", default=False, action="store_true",
                        help="use NUTOT (only al nabki data) NER dataset for pre-training")
